...
\begin{definition} \label{def-disk-itinerary} Let $\zeta_{1},\zeta_{2}\in\partial\D^*$ be two distinct terminals, let  $\eta_{\zeta_{1}}=\left(\sigma_{n}^{1}\right)_{n=0}^{\infty}$ and 
	$\eta_{\zeta_{2}}=\left(\sigma_{n}^{2}\right)_{n=0}^{\infty}$
	 ...
	 Suppose $\sigma=s_{N,k}=\sigma^1_i=\sigma^2_j$. Then the \emph{itinerary} between the two terminals $\zeta_{1},\zeta_{2}\in\partial\D^*$ is defined by  %$\eta_{\zeta_{i}}^{\text{truncated}}=\left(\sigma_{N},\sigma_{N+1}^{i},\ldots\right)$ be the truncated paths. Then
 \begin{gather*}
