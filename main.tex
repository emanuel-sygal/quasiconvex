...
\begin{tikzpicture}
    ...
    \draw [red!70!white]
    (s1) -- node[above, yshift = 4]{$\ell m$} (0,3);
    \draw []
    (0,3) -- node[above] {$\gamma_{m,n}$} (11,3);
    \draw [orange!70!white]
    (11,3) -- node[above, yshift = 4]{$\ell_n$} (s2);
    \draw [orange!70!white, decorate,decoration={snake,segment length=2mm,amplitude=1mm}]    
    (s2) -- node[right] {$\gamma_n$} (w2);
...
\nomenclature{$\mathrm{Exterior}(\mathcal{J}), \; A_\infty(f)$}{The exterior of the Julia set of $f$. The complement of $\mathcal K$.}
