...
This follows from \cref{theorem:hyperbolic_expanding}, in the slightly stronger formulation of \cite{mcmullen} 
since $\mathcal U_{-1}$ is compactly contained in $\hat{\mathbb C} \setminus \Postcrit$, t
