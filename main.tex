...
\begin{theorem}
	...
	% There exists a decreasing homeomorphism $\psi$ of $(0,\infty)$ such that for every ball
	% $B=B(p,r)$ and every continuum disjoint from $B$, we have 
	% $\Mod (B,E) \leq \psi (\Delta(B,E))$.
\end{theorem}

\begin{proof}
	\textcolor{red}{To-do. This is close to saying "the plane is a Loewner space".} 
	Also need to replace later the post-critical set by a connected super-set.
\end{proof}
